...
if __name__ == "__main__":
    ...
    parser.add_argument("--release", required=True, help="The AltTester version to use.")
    parser.add_argument("--assets", required=True, help="The Assets folder path.")
    parser.add_argument("--settings", required=True, help="The build settings file.")
    parser.add_argument("--manifest", required=True, help="The manifest file to modify.")
    parser.add_argument("--buildFile", required=True, help="The build file to modify.")
    parser.add_argument("--buildMethod", required=True, help="The build method to modify.")
    parser.add_argument("--inputSystem", default="old", help="Specify new or old.")
